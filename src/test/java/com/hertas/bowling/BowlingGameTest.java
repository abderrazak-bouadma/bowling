...
public class BowlingGameTest {
    ...
    public void frame1_score_should_equals_5() {
        ...
        game.play(Ball.ONE_PIN_KNOCKED).calculateScore();
        game.play(Ball.FOUR_PIN_KNOCKED).calculateScore();
    ...
    public void frame2_score_should_be_14() {
        ...
        game.play(Ball.FOUR_PIN_KNOCKED).calculateScore();
        game.play(Ball.FOUR_PIN_KNOCKED).calculateScore();
        game.play(Ball.FIVE_PIN_KNOCKED).calculateScore();
        int expected = 14;
    ...
    public void frame3_strike_calculate_score() {
        ...
        game.play(Ball.ONE_PIN_KNOCKED).calculateScore();
        game.play(Ball.FOUR_PIN_KNOCKED).calculateScore();
        game.play(Ball.STRIKE).calculateScore();
        game.play(Ball.FOUR_PIN_KNOCKED).calculateScore();
        game.play(Ball.SIX_PIN_KNOCKED).calculateScore();
    }
}
